    ...
    return (
      <div className="border border-dashed bg-card rounded-2xl py-16 text-center">
        <div className="relative mb-8 h-48">
          <div className="absolute shadow-sm top-0 z-[2] left-[58%] sm:left-[53%] translate-x-[-53%] border w-32 h-48 rounded-xl bg-background transform rotate-12 mx-auto p-4 space-y-2">
